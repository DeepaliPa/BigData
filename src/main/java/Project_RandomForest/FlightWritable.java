...
public class FlightWritable implements Writable{
	...
	public void setIsSane(boolean isSane) {
		this.isSane = new BooleanWritable(isSane);
	}
	...
	public void setCancelled(boolean cancelled) {
		this.cancelled = new BooleanWritable(cancelled);
	}
	public boolean getIsModel() {
		return isModel.get();
	}
	public void setIsModel(boolean isModel) {
		this.isModel = new BooleanWritable(isModel);
	}
	...
	private BooleanWritable isSane;
	private Text year;
	...
	{
		this.isSane=new BooleanWritable(false);
		this.year=new Text();
		...
		this.cancelled=new BooleanWritable(false);
		this.delayed=new IntWritable(0);
		this.isModel=new BooleanWritable(false);
	...
	{
		this.isSane=new BooleanWritable(fl.getIsSane());
