...
public class HPopulate {
    ...
    public static class HPopulateMapper extends
        ...
        /**
         * cleanup will be called once per Map Task after all the Map function
         * calls, we'll close Hbase table connection here
         */
    ...
    /**
     * Connects to the HBase instance and creates table. If table already exists
     * then it deletes the existing table and creates again
     *
     * @throws IOException
